...
Percentile score: how a country’s progress compares to the distribution
...
🔮 Visualizing XXXX TODO: Do we want to add a little vis here?
...
be applied to any other indicator — simply change the WDI code (e.g.,
for education, health, or environmental metrics) and re-run the
function.
