...
**Percentile score:** how a country’s progress compares to the
distribution of all observed experiences

Together, these methods allow to assess historical trends and simulate
future trajectories under different assumptions.

## 🌍 Example: Tracking Undernourishment (WDI)
...
We’ll use the indicator **“Prevalence of undernourishment (% of
population)”**,\
...
`code_col`, `year_col` and `indicator`
...
The output is a list of up to six components, depending on the user’s
settings. Here we’ve enabled both speed and percentile methods, as well
...
```{r}
results_progress$scores # the country-level progress scores for 2015–2024
...
be applied to any other indicator — either simply changing the WDI code
